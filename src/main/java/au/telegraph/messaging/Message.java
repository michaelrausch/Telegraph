...
public class Message {
    ...
    public String asHtml() {
        return "<h3>Message From " + this.getName() + " (" + this.getSenderAddress() + ")</h3>" +
                "<br/>" + getMessage() + "<br/><br/>Please do not reply to this email, send your response to " + this.getSenderAddress();
    }

    @Override
    public String toString() {
        return "Message From " + this.getName() + " (" + this.getSenderAddress() + ")" +
                "\n" + getMessage() + "\n\nPlease do not reply to this email, send your response to " + this.getSenderAddress();
    }
